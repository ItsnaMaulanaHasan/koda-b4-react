    ...
    <footer>
      <div className="grid grid-cols-4 gap-5 bg-[#F8F8F8] px-30 py-20">
        <div className="flex flex-col gap-5 justify-end">
          <div>
            <img src="/public/icon/logo-original.svg" alt="" />
          </div>
          ...
          <ul className="flex items-center justify-start gap-5">
            <li className="bg-[#0B132A] rounded-full">
              <a href="https://www.facebook.com">
                <img src="/public/icon/icon-facebook.svg" alt="Icon Facebook" />
              </a>
            </li>
            <li className="bg-[#0B132A] rounded-full">
              <a href="https://www.x.com">
                <img src="/public/icon/icon-twitter.svg" alt="Icon Twitter" />
              </a>
            </li>
            <li className="bg-[#0B132A] rounded-full">
              <a href="https://www.instagram.com">
                <img
                  src="/public/icon/icon-instagram.svg"
                  alt="Icon Instagram"
                />
              </a>
            </li>
